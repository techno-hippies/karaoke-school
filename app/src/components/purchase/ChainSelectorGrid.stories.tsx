...
// Current state: Base only enabled, others coming soon
const CURRENT_CHAINS: ChainOption[] = [
  ...
  { id: 42161, name: 'Arbitrum', icon: '/images/arbitrum-chain.svg', nativeToken: 'ETH', disabled: true },
  { id: 10, name: 'Optimism', icon: '/images/optimism-chain.svg', nativeToken: 'ETH', disabled: true },
]

// Future: All chains enabled
const ALL_CHAINS_ENABLED: ChainOption[] = [
  { id: 8453, name: 'Base', icon: '/images/base-chain.svg', nativeToken: 'ETH' },
...
/** Default - Base only enabled, others coming soon (current state) */
...
/** Base selected - shows wallet address and balance */
export const BaseSelected: Story = {
  render: () => {
    const [selectedChain, setSelectedChain] = createSignal<ChainOption | undefined>(CURRENT_CHAINS[0])
...
/** Interactive - tap Base to select, shows loading then balance */
export const Interactive: Story = {
  render: () => {
    const [selectedChain, setSelectedChain] = createSignal<ChainOption | undefined>()
    const [balances, setBalances] = createSignal<{ native?: number; loading?: boolean }>({})
...
/** Future: All chains enabled */
export const AllChainsEnabled: Story = {
  render: () => {
    const [selectedChain, setSelectedChain] = createSignal<ChainOption | undefined>()
