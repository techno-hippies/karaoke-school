 ...
 *
 * Used by:
 * - Chat: Simple recording → WAV → base64 for STT
 * - Study/SayItBack: Same simple flow
 * - Karaoke: Continuous recording with timestamp-based slicing per line
 */
 ...
 *
 * Used by karaoke line grading to extract per-line audio from continuous recording.
 *
...
/**
 * Convert blob to base64 string (no data URI prefix)
 */
