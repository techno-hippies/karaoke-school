...
/**
 * KaraokeEvents.sol - Emits KaraokePerformanceGraded events
 */
...
/** Karaoke Grader v1 - Full clip/song grading */
export const LIT_KARAOKE_GRADER_CID = litCids.karaoke
...
/** Encrypted Voxtral key for Karaoke Grader */
export const LIT_KARAOKE_VOXTRAL_KEY = karaokeVoxtralKey

/** Encrypted OpenRouter key for Karaoke Grader */
export const LIT_KARAOKE_OPENROUTER_KEY = karaokeOpenrouterKey
