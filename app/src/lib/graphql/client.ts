...
const SUBGRAPH_ENDPOINTS = {
  ...
  // v6-json-localizations: V6 contract with JSON localizations for 12 languages
  studio: 'https://api.studio.thegraph.com/query/1715685/kschool-alpha-1/v6-json-localizations',
}
