 ...
 *   en (English), zh (Chinese), vi (Vietnamese), id (Indonesian),
 *   ja (Japanese), ko (Korean), es (Spanish), pt (Portuguese),
 *   ar (Arabic), tr (Turkish), ru (Russian), hi (Hindi), th (Thai)
 *
 * Usage:
...
export type UILanguage = 'en' | 'zh' | 'vi' | 'id' | 'ja' | 'ko' | 'es' | 'pt' | 'ar' | 'tr' | 'ru' | 'hi' | 'th'
...
export const SUPPORTED_UI_LANGUAGES: readonly UILanguage[] = ['en', 'zh', 'vi', 'id', 'ja', 'ko', 'es', 'pt', 'ar', 'tr', 'ru', 'hi', 'th']
