...
export const ArtistPage: Component = () => {
  ...
  const songs = createMemo(() => {
    ...
    return artist.data.songs.map((song) => {
      ...
      const localizedTitle = getLocalizedTitle(song, uiLanguage()) || song.title
          ...
          <div class="relative w-full h-full md:max-w-4xl flex flex-col">
            ...
            <div class="absolute top-0 left-0 right-0 z-50 pt-safe">
              <div class="flex items-center justify-between p-4">
                <button
                  onClick={handleBack}
                  class="w-10 h-10 rounded-full flex items-center justify-center bg-black/30 hover:bg-black/50 transition-colors cursor-pointer"
                >
                    ...
                    <div class="flex-1 min-w-0">
                      <h1 class="text-foreground text-2xl md:text-4xl font-bold">
                        {getLocalizedArtist({
                          ...
                          artist_zh: artist.data!.name_zh,
                          artist_vi: artist.data!.name_vi,
                          artist_id: artist.data!.name_id,
                          artist_ja: artist.data!.name_ja,
                          artist_ko: artist.data!.name_ko,
                          artist_es: artist.data!.name_es,
                          artist_pt: artist.data!.name_pt,
                          artist_ar: artist.data!.name_ar,
                          artist_tr: artist.data!.name_tr,
                          artist_ru: artist.data!.name_ru,
                          artist_hi: artist.data!.name_hi,
                          artist_th: artist.data!.name_th,
                        }, uiLanguage()) || artist.data!.name}
                      </h1>
                    </div>
                  </div>
                </div>
