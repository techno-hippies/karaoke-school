...
// Note: Use dotenvx to decrypt .env file
// Run with: DOTENV_PRIVATE_KEY='...' bun run scripts/test-karaoke-scorer-v4.mjs
...
async function loadVoxstralKeyEncryption() {
  ...
  const keyPath = '/media/t42/th42/Code/site/lit-actions/src/stt/keys/voxstral_api_key_v4.json';
