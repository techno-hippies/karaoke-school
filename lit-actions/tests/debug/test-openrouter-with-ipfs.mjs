...
const LIT_ACTION_CID = 'QmUEXAWiN86KAXPzNWLTvnCW4mzLy3gWe7gLgvyBfUhnyk';

async function main() {
  console.log("🧪 Testing Karaoke Grader with testMode (via IPFS)\n");
  ...
  const jsParams = {
    ...
    testMode: true,  // Test mode - should be fast
  };

  console.log("🚀 Executing via IPFS CID with testMode=true...\n");
