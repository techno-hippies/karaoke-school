/**
 * Audio Task: Segment Selection (Simple/Deterministic)
 *
 * Uses normalized_lyrics section breaks to deterministically select
 * the first 40-100s of actual lyrics (skipping instrumental intro).
 *
 * Algorithm:
 * 1. Get normalized_lyrics and split by double newlines
 * 2. Accumulate sections from start until we reach 40-100s
 * 3. Match text to karaoke_lines timestamps
 * 4. Store clip_start_ms / clip_end_ms
 *
