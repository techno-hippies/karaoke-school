...
async function main() {
  ...
  const { profile: profileMetadata } = await import('@lens-protocol/metadata');
  ...
  const metadata = profileMetadata({
    ...
    bio,
    attributes: [
      { type: 'String', key: 'pkpAddress', value: account.pkp_address },
      { type: 'String', key: 'accountType', value: account.account_type },
      { type: 'String', key: 'handle', value: handle },
    ],
  });
