...
// Contract config - ClipEvents (NOT KaraokeEvents!)
const CLIP_EVENTS_ADDRESS = '0x369Cd327c39E2f00b851f06B6e25bb01a5149961';
const RPC_URL = 'https://rpc.testnet.lens.xyz';

const CLIP_EVENTS_ABI = [
...
async function main() {
  ...
  const contract = new ethers.Contract(CLIP_EVENTS_ADDRESS, CLIP_EVENTS_ABI, wallet);

  console.log(`   Wallet: ${wallet.address}`);
  console.log(`   Contract: ${CLIP_EVENTS_ADDRESS}`);
