#!/usr/bin/env bun
/**
 * Encrypt Full Audio with Hybrid Encryption (v2)
 *
 ...
 *
 * Usage:
 *   bun src/scripts/encrypt-audio-v2.ts --iswc=T0101545054
 *   bun src/scripts/encrypt-audio-v2.ts --iswc=T0101545054 --env=mainnet
 *   bun src/scripts/encrypt-audio-v2.ts --iswc=T0101545054 --dry-run
 */
