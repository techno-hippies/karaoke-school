 ...
 *
 * Output:
 *   Updated manifest with Grove URIs for videos, thumbnails, and metadata
 */
...
async function uploadToGrove(tiktokHandle: string): Promise<void> {
  console.log('\n☁️  Step 12: Uploading Videos to Grove Storage');
  console.log('═══════════════════════════════════════════════════════\n');
