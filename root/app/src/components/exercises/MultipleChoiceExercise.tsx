...
export interface MultipleChoiceExerciseProps {
  ...
  /** Whether the exercise is processing the answer */
...
export const MultipleChoiceExercise = ({
  ...
  const getOptionStyles = (option: MultipleChoiceOption) => {
    const baseStyles = "w-full flex items-center gap-3 p-4 md:p-5 rounded-lg transition-all cursor-pointer border min-h-[60px]"
