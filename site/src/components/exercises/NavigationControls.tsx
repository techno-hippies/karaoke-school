        ...
        <div className="space-y-2">
          ...
          {reportReasons.map((reason) => (
            <button
              ...
              className="w-full p-3 text-left bg-neutral-700 hover:bg-neutral-600 text-white rounded-lg transition-colors text-sm"
            >
              {reason.label}
            </button>
          ))}
          <button
            ...
            className="w-full p-3 text-center text-neutral-400 hover:text-white transition-colors text-sm"
          >
            Cancel
          </button>
        </div>
        ...
        <div className="flex gap-3">
          {onReport && exerciseKey && (
            <Button
              ...
              variant="outline"
              size="lg"
              className="h-[52px] border-neutral-600 bg-transparent text-neutral-400 hover:bg-transparent hover:text-white hover:border-neutral-500"
          ...
          <Button
            ...
            disabled={disabled}
            size="lg"
            className="flex-1 h-[52px] bg-blue-600 hover:bg-blue-700"
          >
            {label}
