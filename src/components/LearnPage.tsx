...
export const LearnPage: React.FC = () => {
  ...
  if (showStudySession) {
    return <StudySession onExit={handleExitStudy} />
  }
          ...
          <div className="max-w-4xl mx-auto p-6 space-y-8">
            ...
            <div className="bg-neutral-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-white">Study Cards ({allCards.length})</h2>
              </div>
              ...
              {allCards.length === 0 ? (
                ...
                <div className="space-y-3">
                  {allCards.map((card) => (
                    <div key={card.card_id} className="bg-neutral-700 rounded-lg p-4">
                      <div className="flex justify-between items-start gap-4">
                        ...
                        <button
                          ...
                          className="text-red-400 hover:text-red-300 text-sm px-3 py-1 rounded border border-red-400 hover:border-red-300 transition-colors flex-shrink-0"
                        >
                          Delete
                        </button>
                      </div>
            ...
            <div className="bg-neutral-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-white">Liked Songs ({likedSongs.length})</h2>
              </div>
